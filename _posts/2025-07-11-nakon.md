...
![Preset panel in editor](../assets/media/preset.png)
...
<figure style="text-align: center;">
    <video controls style="border: 1px white solid; max-width: 100%;">
        <source src="../assets/media/nuke.mp4" type="video/mp4"/>
    </video>
...
<figure style="text-align: center;">
    <video controls style="border: 1px white solid; max-width: 100%;">
        <source src="../assets/media/freeze.mp4" type="video/mp4"/>
    </video>
...
<figure style="text-align: center;">
    <video controls style="border: 1px white solid; max-width: 100%;">
        <source src="../assets/media/weapon-unlocking.mp4" type="video/mp4"/>
    </video>
